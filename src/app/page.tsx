...
import { DumbbellIcon, LeafIcon, LogInIcon, PulseIcon } from "@/components/icons";
...
const pillars = [
  ...
  },
  {
    Icon: LeafIcon,
    title: "Nutrição",
    body: "Dieta pensada pra vida real: marmita, RU, delivery. Metas claras, sem contar calorias a vida toda.",
  },
  {
    Icon: PulseIcon,
  ...
  return (
    <div className="flex flex-col">
      ...
      <section id="pilares" className="px-6 md:px-16 pt-8 pb-16 md:pb-24 border-t border-line">
        <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-6 mb-10">
          <h2 className="font-display font-bold uppercase tracking-[-0.02em] text-3xl md:text-[38px] max-w-[520px]">
            Um método, três frentes que se sustentam.
          </h2>
          <p className="text-ink-soft text-[15px] max-w-[320px]">
            Cada parte da sua semana falando com a outra — treino, prato e
            sono.
          </p>
        </div>
      ...
      <footer className="bg-ink-bg text-on-ink px-6 md:px-16 pt-14 pb-10 mt-auto">
        ...
        <div className="pt-6 text-on-ink-soft text-xs">© {new Date().getFullYear()} Onmode</div>
      </footer>
    </div>
  );
}
